...
#### 22. 대시보드 개편 (2024-12-10)
- [x] DashboardCalendar 컴포넌트 생성 (src/components/DashboardCalendar.tsx)
  - [x] react-native-calendars 연동
  - [x] 스케줄 날짜별 마킹 (수거: 녹색, 기타: 파랑)
  - [x] 선택된 날짜의 일정 목록 표시
  - [x] 일정 클릭 시 상세 페이지 이동
- [x] 클라이언트 대시보드 개편 (app/(tabs)/index.tsx)
  - [x] 수거 현황 요약 카드 (다음 수거일 D-Day, 전체/완료/검토 대기)
  - [x] 검토 대기 알림 배너 (클릭 시 해당 프로젝트 이동)
  - [x] 캘린더 뷰 (수거 일정 확인)
  - [x] 진행 중인 수거 목록 (위치, 일정, 완료 현황)
- [x] 마스터 대시보드 개편 (app/(tabs)/index.tsx)
  - [x] 통계 카드 4개 (전체 프로젝트, 이번 달 완료, 담당 매장, 지원 가능)
  - [x] 캘린더 뷰 (작업 일정 확인)
  - [x] 진행 중인 프로젝트 목록 (위치, 일정 표시)
  - [x] 최근 완료 프로젝트 목록
...
└── components/
    ...
    └── DashboardCalendar.tsx # 대시보드 캘린더 컴포넌트
```
